...
public class all_request_adapter extends RecyclerView.Adapter <all_request_adapter.allRequestViewHolder>{
    private Context mContext;
    private List<userDetails> mUserDetails;
    private OnItemClickListener mListener;

    public all_request_adapter(Context mContext, List<userDetails> mUserDetails) {
    ...
    public allRequestViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new allRequestViewHolder(v);
    }
    ...
    public class allRequestViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener,
            ...
            if (mListener != null) {
                ...
                if (position != RecyclerView.NO_POSITION) {
                    switch (item.getItemId()) {
                        case 1:
                            mListener.onAllow(position);
                            return true;
                        case 2:
                            mListener.onDeny(position);
                            return true;
                    }
                }
            }
        ...
        public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
            ...
            MenuItem onAllow = menu.add(Menu.NONE, 1, 1, "Accept");
            MenuItem onDeny = menu.add(Menu.NONE, 2, 2, "Deny");
            onAllow.setOnMenuItemClickListener(this);
            onDeny.setOnMenuItemClickListener(this);
        }
    }

    public interface OnItemClickListener {
        void onItemClick(int position);
        void onAllow(int position);
